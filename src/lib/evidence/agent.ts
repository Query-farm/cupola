...
export const EVIDENCE_AGENT_TOOLS: Tool[] = [
  ...TOOLS.filter(tool => ['list_catalogs', 'list_tables', 'describe_table', 'describe_function'].includes(tool.name)),
