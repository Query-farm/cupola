...
/**
 * Block types offered by "Add block". Each description says, in a reader's
 * terms, what the block shows and when to reach for it — the picker and the
 * block editor both display it, since several names (bullet, range dot,
 * slopegraph) are chart jargon.
 */
export const REPORT_BLOCK_TYPES: Array<{ type: ReportBlock["type"]; label: string; group: "Text" | "Metrics" | "Visualizations" | "Data"; description: string }> = [
  { type: "markdown", label: "Text", group: "Text", description: "Headings, notes, and explanations you write yourself." },
  { type: "ai_narrative", label: "AI narrative", group: "Text", description: "A written summary of a dataset, generated by AI." },
  { type: "kpi", label: "KPI", group: "Metrics", description: "One headline number, optionally placed within a range." },
  { type: "sparkline", label: "Sparkline", group: "Metrics", description: "A headline number with a small trend line." },
  { type: "bullet", label: "Bullet chart", group: "Metrics", description: "Actual versus target, one bar per row." },
  { type: "range_dot", label: "Range dot", group: "Metrics", description: "A low-to-high span per row, with the current value marked." },
  { type: "slopegraph", label: "Slopegraph", group: "Visualizations", description: "How each row changed between two points in time." },
  { type: "small_multiples", label: "Small multiples", group: "Visualizations", description: "The same small chart repeated for each category." },
  { type: "chart", label: "Chart", group: "Visualizations", description: "A bar, line, area, or point chart you configure." },
  { type: "map", label: "Map", group: "Visualizations", description: "Points or shapes on a map, from coordinates or geometry." },
  { type: "table", label: "Table", group: "Data", description: "Rows and columns of a dataset." },
  { type: "perspective", label: "Perspective", group: "Data", description: "An interactive pivot table readers can regroup and filter." },
];
